...
export class UsersService {
  ...
  async create(createUserDto: CreateUserDto) {
    ...
    const company1 = await this.companyRepository.save({ name: 'CHAPA Inc.',  avlShares:500, pricePerShare: 1000, totalShares: 500  });

    // Save the share and associate it with the company

    // Now create ownerships for the shares
